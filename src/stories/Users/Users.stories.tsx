...
import { UserTiny, FollowState } from '../../reducers/follows'
...
const followsData: FollowState = {
  followings: [
    ...
    },
    {
      ...
      name: '太郎',
      photoUrl:
        'https://cdn-natgeo.nikkeibp.co.jp/atcl/gallery/020500145/06.jpg?__scale=w:1190,h:791&_sh=0af0100980',
    },
  ],
  followers: [
    {
      ...
      name: 'tono',
      photoUrl:
        'https://storage.tenki.jp/storage/static-images/suppl/article/image/9/97/971/9711/1/large.jpg',
    },
    {
      uid: 'i4ac4evjvhc7cv5x',
      name: '坂本龍馬',
      photoUrl:
        'https://cdn-ak.f.st-hatena.com/images/fotolife/k/kiichangazie/20171203/20171203131011.png',
    },
  ],
}
