...
const UserIconComponent = (
  <div className="content" style={{ float: 'left', textAlign: 'left' }}>
    <div
    ...
    <div className="content">
      ...
      <div className="ui input focus" css={largeInputFieldStyle} style={{ textAlign: 'left' }}>
        <input
          type="text"
          name="comment"
          placeholder="「記事投稿しました！」「賞をとりました！」「●章を読みました！」"
        />
      </div>
    </div>
  </div>
...
const PostPopup: FC<PostPopupprops> = ({ showPopup = false, UserName = null, UserIcon = null }) => (
